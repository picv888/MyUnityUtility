...
public abstract class DecoratorEditor : Editor {
    ...
    /// 输出所有Editor类名
    /// </summary>
    [MenuItem("MyUtility/LogAllEditor")]
    public static void LogAllEditorClass() {
        List<System.Type> listType = new List<System.Type>(editorAssembly.GetTypes());
        listType.Sort((a, b) => string.Compare(a.Name, b.Name));
        string log = "所有Editor类:";
